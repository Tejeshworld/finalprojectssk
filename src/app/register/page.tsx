        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <select
              ...
              style={{ WebkitAppearance: 'none', appearance: 'none', background: 'var(--bg-secondary)', color: 'var(--text-primary)' }}
            >
              <option value="" style={{ background: 'var(--bg-secondary)', color: 'var(--text-muted)' }}>Select your year...</option>
              <option value="1" style={{ background: 'var(--bg-secondary)', color: 'var(--text-primary)' }}>1st Year</option>
              <option value="2" style={{ background: 'var(--bg-secondary)', color: 'var(--text-primary)' }}>2nd Year</option>
              <option value="3" style={{ background: 'var(--bg-secondary)', color: 'var(--text-primary)' }}>3rd Year</option>
              <option value="4" style={{ background: 'var(--bg-secondary)', color: 'var(--text-primary)' }}>4th Year</option>
              <option value="5" style={{ background: 'var(--bg-secondary)', color: 'var(--text-primary)' }}>5th Year +</option>
            </select>
          </div>
          <div className="form-group">
