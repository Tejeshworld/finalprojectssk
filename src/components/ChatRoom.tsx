...
import { HiOutlineScale, HiOutlineWifi, HiOutlineBolt } from 'react-icons/hi2';
          ...
          <div className="lounge-auth-card">
            <div className="text-center" style={{ marginBottom: '3rem' }}>
              <div className="lounge-icon-wrapper">
                <HiOutlineScale size={48} className="text-indigo-400" />
              </div>
            ...
            {messages.length === 0 ? (
              <div className="h-full flex flex-col items-center justify-center">
                <div className="w-20 h-20 rounded-full border-4 border-dashed border-white/5 flex items-center justify-center mb-6 animate-pulse">
                  <HiOutlineWifi size={40} className="text-gray-400" />
                </div>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="relative group/content max-w-full inline-block">
                        <div
                          className={`text-[14px] text-slate-200 leading-relaxed font-semibold px-6 py-4 rounded-[24px] shadow-2xl transition-all border ${isMine
              ...
              <form onSubmit={handleSendMessage} className="group relative">
                ...
                <div className="absolute right-5 top-1/2 -translate-y-1/2 flex items-center gap-3">
                  <button
                    ...
                    className={`h-14 px-8 rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] transition-all flex items-center gap-2 ${inputValue.trim()
